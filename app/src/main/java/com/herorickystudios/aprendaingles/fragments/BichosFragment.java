...
public class BichosFragment extends Fragment implements View.OnClickListener {
    ...
    private ImageButton butonCao, ButtonCat, ButtonLeao, ButtonMamaco, ButtonOvelha, ButtonVaca;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ButtonMamaco = view.findViewById(R.id.ButtonMamaco);

        ButtonVaca = view.findViewById(R.id.ButtonVizinha);
        ...
        ButtonMamaco.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.ButtonMamaco:
                mediaPlayer =  MediaPlayer.create(getActivity(), R.raw.monkey);
                tocarSom();
                break;

            case R.id.ButtonVizinha:
